        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php echo $this->lang->line('country'); ?> <?php echo $this->lang->line('management'); ?>
                    </h3>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <?php echo $this->lang->line('country'); ?> <?php echo $this->lang->line('list'); ?>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                    <thead>
                                        <tr role="row" class="heading">
                                            ...
                                            <th><?php echo $this->lang->line('phone').' '.$this->lang->line('code'); ?></th>
                                            <th><?php echo $this->lang->line('status')?></th>
                                            <th><?php echo $this->lang->line('action'); ?></th>
                                        </tr>
                                        <tr role="row" class="filter">
                                            <td></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="iso"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="nicename"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="phonecode"></td>
                                            <td>
...
<script>
var grid;
var country_count = <?php echo ($country_count)?$country_count:0; ?>;
        ...
        dataTable: {
           ...
           "aoColumns": [
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && country_count != 0 && oData.iStart >= country_count){
                    oData.iStart = 0;
...
function onOffDetails(ID,set_default)
{
    bootbox.confirm({
        message: "<?php echo $this->lang->line('set_country_default_msg'); ?>",
        buttons: {
            confirm: {
                label: "<?php echo $this->lang->line('ok'); ?>",
            },
        ...
        callback: function (disableConfirm) {    
            if (disableConfirm) {
                jQuery.ajax({
                  ...
                  dataType : "json",
                  url : 'setDefault',
                  data : {'entity_id':ID,'set_default':set_default},
                  success: function(response) {
                       grid.getDataTable().fnDraw(); 
                  },
                  error: function(XMLHttpRequest, textStatus, errorThrown) {           
