        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                    <?php echo $this->lang->line('titleadmin_email_template') ?>
                    </h3>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <?php echo $this->lang->line('titleadmin_email_template') ?> <?php echo $this->lang->line('list') ?>
                            </div>
                            <div class="actions c-dropdown">
                                <?php if(in_array('email_template~add',$this->session->userdata("UserAccessArray"))) { ?>
...
<script>
var grid;
var template_count = <?php echo ($template_count)?$template_count:0; ?>;
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
           ...
           "aoColumns": [
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && template_count != 0 && oData.iStart >= template_count){
                    oData.iStart = 0;
...
function disableDetail(content_id,status)
{
