                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <?php echo $this->lang->line('payment_methods'); ?> <?php echo $this->lang->line('list'); ?>
                            </div>
                        </div>
...
<script>
var grid;
var payment_method_count = <?php echo ($payment_method_count)?$payment_method_count:0; ?>;
        ...
        dataTable: {
           ...
           "aoColumns": [
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && payment_method_count != 0 && oData.iStart >= payment_method_count){
                    oData.iStart = 0;
