        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                    <?php echo $this->lang->line('imported_res') ?>
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name.'/view';?>">
                            <?php echo $this->lang->line('restaurant') ?> </a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo $this->lang->line('imported_res_list'); ?></div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <?php } if($_SESSION['Import_users_limit'])
                            { ?>
                                <div class="alert alert-danger">
                                     <?php echo $_SESSION['Import_users_limit'];
                                     unset($_SESSION['Import_users_limit']);
                                     ?>
                                </div>
                            <?php } ?>
                                            ...
                                            <tr>
                                                ...
                                                if (!empty($this->session->userdata('import_data')['Import'])) {
                                                    foreach ($this->session->userdata('import_data')['Import'] as $key => $value) {
                                                        if ($akey == $key+2) {
                                                            if ($value[0] == "New Added") {
                                                                $status = "New Added";
                                                            }
                                                            else if ($value[0] == "Updated") {
                                                                $status = "Updated";
                                                            }
                                                            else
                                                            {
                                                ...
                                                <?php if (!empty($this->session->userdata('import_data')['Import'])) {
                                                    foreach ($this->session->userdata('import_data')['Import'] as $key => $value) {
                                                        if ($akey == $key+2) {
                                                            $Errors = implode(" ", str_replace("*", "", $value));
                                                        }
                                                    }  
                                                } ?>
