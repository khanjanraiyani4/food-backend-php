        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                       <?php echo $this->lang->line('faq_questions'); ?>
                    </h3>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            <div class="portlet-title">
                                <div class="caption"><?php echo $this->lang->line('faq_questions') ?></div>
                                <div class="actions c-dropdown">
                                    <?php if(in_array('faqs~ajaxDisableAll',$this->session->userdata("UserAccessArray"))) { ?>
                                    ...
                                    <?php } ?>
                                    <?php if(in_array('faqs~add',$this->session->userdata("UserAccessArray"))) { ?>
...
<script>
    var grid;
    var faq_count = <?php echo ($faq_count)?$faq_count:0; ?>;
    ...
    grid.init({
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && faq_count != 0 && oData.iStart >= faq_count){
                    oData.iStart = 0;
