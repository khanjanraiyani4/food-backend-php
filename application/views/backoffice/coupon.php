        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php echo $this->lang->line('admin_coupons'); ?>
                    </h3>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo $this->lang->line('admin_coupons'); ?> <?php echo $this->lang->line('list'); ?></div>
                            <div class="actions">
                                <?php if(in_array('coupon~add',$this->session->userdata("UserAccessArray"))) { ?>
...
<script>
var grid;
var coupon_count = <?php echo ($coupon_count)?$coupon_count:0; ?>;
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
           ...
           "aoColumns": [
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && coupon_count != 0 && oData.iStart >= coupon_count){
                    oData.iStart = 0;
...
// method for deleting
function deleteDetail(entity_id, image, message)
{   
   bootbox.confirm({
        message: message,
        buttons: {
