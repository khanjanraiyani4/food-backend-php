                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            ...
                            <div class="actions c-dropdown">                                     
                                <?php if(in_array('cms~edit',$this->session->userdata("UserAccessArray"))) { ?>
                                    <button id="addbutton" type="button" class="btn btn-sm default-btn dropdown-toggle" data-toggle="dropdown"
...
var grid;
var cms_count = <?php echo ($cms_count)?$cms_count:0; ?>;
        ...
        dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
           ...
           "aoColumns": [
            ...
            "fnStateSave": function (oSettings, oData) {
                if(oSettings.aoData.length == 0 && cms_count != 0 && oData.iStart >= cms_count){
                    oData.iStart = 0;
