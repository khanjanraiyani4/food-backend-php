                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box red">
                            ...
                            <div class="actions c-dropdown">
                                <?php if(in_array('addons_category~ajaxDisableAll',$this->session->userdata("UserAccessArray"))) { ?>
                                ...
                                <?php } ?>
                                <?php if(in_array('addons_category~add',$this->session->userdata("UserAccessArray"))) { ?>
...
<script>
    ...
    var addons_category_count = <?php echo ($addons_category_count)?$addons_category_count:0; ?>;
    ...
    var Datatable = $('#datatable_ajax').DataTable({
        ...
        "stateSaveCallback": function (oSettings, oData) {
            console.log(addons_category_count);
            if(oSettings.aoData.length == 0 && addons_category_count != 0 && oData.start >= addons_category_count){
                oData.start = 0;
        ...
        "fnServerParams": function ( aoData ) {
            aoData.push(
                ...
                { "name": "restaurant_id_for_add_ons", "value": $('#restaurant_owner_id').find(':selected').attr('data-restaurant-id') }
            );
        }
    });
    ...
    //activate multiple addons categories
            ...
            bootbox.confirm({
                ...
                callback: function (activeConfirm) {  
                    if (activeConfirm) {
                        jQuery.ajax({
                          type : "POST",
                          url : 'activeDeactiveMultiAddonsCat',
    ...
    //deactivate multiple addons categories
