...
if($this->input->post()){
    ...
    $FieldsArray = array('content_id','entity_id','name','sequence');
...
{
    $add_label    = $this->lang->line('edit_faq_category');
...
{
    $add_label = $this->lang->line('add_faq_category');
        ...
        <div class="page-content">            
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title"><?php echo $this->lang->line('faq_category') ?></h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name?>/view"><?php echo $this->lang->line('faq_categories') ?></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <?php echo $add_label;?> 
                            ...
                            <form action="<?php echo $form_action;?>" id="form_add_<?php echo $this->prefix ?>" name="form_add_<?php echo $this->prefix ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="form-body">                                     
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="sequence" id="sequence" value="<?php echo $sequence;?>" data-required="1" min="1" class="form-control" oninput="checkExist(this.value)" />
...
//check FAQ Category Sequence number already alotted  to other FAQ category
function checkExist(sequence){
    var entity_id = $('#entity_id').val();
    $.ajax({
    type: "POST",
    url: BASEURL+"<?php echo ADMIN_URL ?>/faq_category/checkExist",
